...
const PromoEdit = (props) => {
        ...
        props.firebase.promo(id).get()
            .then(doc => {
                if (doc.exists) {
                    ...
                    setPromoType(res.promo_type);
                    setDiscountAmount(res.discount_amount);
                    setDuration(res.duration);
                    setDateType(res.date_type);
                    setExpirationDate(res.expiration);
                    setLimitPerCoupon(res.limit_coupon);
                    setLimitPerCustomer(res.limit_customer);
                    setPromoTiers(res.promo_tiers);
                    setActivate(res.activate);
    ...
    const update = () => {
        ...
        var ref = props.firebase.promo(props.match.params.id);
                            ...
                            <div className="col-12">
                                <div className="dashboard__header">
                                    <ul className="breadcumb">
                                        ...
                                        <li className="active">Edit Promo</li>
                                    </ul>
...
export default compose(withFirebase, withAuthorization(condition))(PromoEdit);
